...
public class BoardRepositoryTest {
    ...
    public void updateTest() {
        Board board = boardRepository.findById(35L).get();
    ...
    public void testTitleList() {
        ...
        // boardRepository.findByTitleContainingAndIdGreaterThan("Title", 30L).forEach(b
        // -> System.out.println(b));

        // boardRepository.findByIdGreaterThanOrderByIdDesc(30L).forEach(b ->
        // System.out.println(b));
