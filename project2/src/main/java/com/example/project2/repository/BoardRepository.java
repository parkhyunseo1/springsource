...
public interface BoardRepository extends JpaRepository<Board, Long> {
    ...
    // // where writer like '%writer% '
    // List<Board> findByWriterContaining(String wirter);

    // // where writer like '%writer%' or title like '%title%'

    // List<Board> findByWriterContainingOrTitleContaining(String wirter, String
    // title);

    // // // where writer like '%title%' and id > 10
