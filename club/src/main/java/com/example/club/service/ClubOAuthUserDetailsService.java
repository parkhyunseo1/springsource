...
import com.example.club.respository.ClubMemberRepository;
...
public class ClubOAuthUserDetailsService extends DefaultOAuth2UserService {
    ...
    // 소셜로그인 정보를 이용한 회원가입
    private ClubMember saveSociaClubMember(String eamil) {

        // 소셜 로그인 계정으로 가입한 회원 여부 확인
        Optional<ClubMember> result = clubMemberRepository.findByEmailAndFromSocial(eamil, true);
